...
{
    public class ExperienciaController: ApiController //: ArchibobaseExperienciaController
    {
        ...
        [HttpPost]
        [ActionName("ListarExperiencia")]
        public List<Experiencia> ListarExperiencia(Experiencia entidad)
        {
            try
            {
                return experienciaDL.ListarExperiencia(entidad);
            }
            catch (Exception ex)
            {
                throw ex;
