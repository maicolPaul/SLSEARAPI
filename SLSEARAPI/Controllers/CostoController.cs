...
namespace SLSEARAPI.Controllers
{
    public class CostoController : ApiController
    {
        ...
        [HttpPost]
        [ActionName("ExportarFichaTecnica")]
        public HttpResponseMessage ExportarFichaTecnica(FichaTecnica fichaTecnica)
        {
            try
            {
                List<FichaTecnica> ficha = costoDL.ListarfichaTecnicaRpt(fichaTecnica);

                String NombreReporte = "Informacion_General";
